...
public class ReusableMethods {
    ...
    public static void highlightElement(WebDriver driver, WebElement element) {
            ...
            // JavaScriptExecutor aracılığıyla kodu çalıştır
            ((JavascriptExecutor) driver).executeScript(jsCode, element);

            // Belirli bir süre sonra rengi geri almak için bir setTimeout fonksiyonu kullanabiliriz
            try {
                Thread.sleep(3000); // 1 saniye bekle
            } catch (InterruptedException e) {
                e.printStackTrace();
            }

            // Rengi geri al
            jsCode = "arguments[0].style.backgroundColor = '';";
            ((JavascriptExecutor) driver).executeScript(jsCode, element);
    }
